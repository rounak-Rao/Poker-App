...
class GameManager:
    ...
    def initialize_hand(self):
        ...
        self.bet = Betting(self.players, sb, bb)
        self.deck.shuffle()
        self.deal_cards()
    ...
    def determine_winner(self):
        win = Winner(self.bet.players_in_hand, self.community_cards)
        winning_players = win.winner()

    def continue_betting_rounds(self):
        return len(self.bet.active_players)
